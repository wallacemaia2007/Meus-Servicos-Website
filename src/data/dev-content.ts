...
export const site = {
  ...
  name: "Maiawall",
  fullName: "Maiawall",
  title: "Maiawall | Serviços Web, CRM e ERP por Wallace Maia",
  description:
    "Empresa de tecnologia de Wallace Maia especializada em desenvolvimento web, sites, landing pages, CRM, ERP, dashboards, e-commerces, sistemas e APIs sob medida.",
  shortDescription:
    "Desenvolvimento web, CRM, ERP, sites, landing pages e sistemas sob medida para negócios que precisam vender, organizar e crescer.",
  searchTerms: [
    "Wallace Maia",
